---
layout: default
title: ReproProof documentation
---

# ReproProof documentation

ReproProof turns bug-report prose into structured analysis, a reviewable failing-test patch, and execution evidence.

- [Research](oss-program-research.md)
