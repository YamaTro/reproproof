...
> Pre-release status: the offline MVP works on controlled Node and Python fixtures. It has no external adoption yet and local execution is not a hardened security sandbox.
...
- The Action has not yet been exercised in a public GitHub runner.
